  ...
  <body>
    ...
    <div class="all">
        ...
        <div class="search_btn" >
            <form action="search_med.php" method="POST" onsubmit="return check()">
            ...
            <table class="tb">
                ...
                <?php 
                   ...
                   $number_pages = ceil($num_of_result/$result_per_page);
                    ...
                    $sql1 = "SELECT * FROM new_med ORDER BY M_name LIMIT ". $start_limit_num . ',' . $result_per_page;
                    ...
                    if (mysqli_num_rows($result1)>0)
                    {
                       while ($row=mysqli_fetch_array($result1)) 
                       {
                          ...
                          echo "<td>".$row['Mg']."</td>";
                          echo "<td style='text-align:center'> <a href='updatemedform.php?id=".$row[0]."' class= 'edit'>Edit</a> 
            ...
            <?php
                ...
                {
                    echo '<a class="page" href="med.php?page='.$page.'">'.$page.'</a>';
                }
