...
?>
            ...
            <div class="menu">
              <ul><li class="dash"><a href="doc_dashboard.php" >Dashboard</a></li><hr>
                ...
                <fieldset>
                  ...
                  <li class="pre"><a href="prescription.php" class="p">Prescribtion</a>
                      <ul>
                          <li>
      ...
      <div class="nav_bar">
        <ul>
          <li>
          <?php 
                echo "<td> <a href='prescription_page.php?id=".$row[0]."' id='onlink'>Medicine</a></td></table>"; 
          ?>
          <li>
          <?php 
                echo "<td> <a href='test_page.php?id=".$row[0]."'>Test</a></td></table>"; 
          ?>
      </li>
        </ul>
        ...
        <tr>
          ...
          $pres="SELECT * from pre_med where id=$id ORDER BY date desc";
              ...
              while ($rowmed=mysqli_fetch_assoc($resmed))
              {
                ...
                echo "<td><a href='deletemed.php?delid=".$row['pres_med']."' class='delete'>Delete</a></td>";
							echo "</tr>";
						}
					}
				else
