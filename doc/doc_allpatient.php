  ...
  <body>
    ...
    ?>
        ...
        <div class="all">
            ...
            <form action="docsearch_all.php" method="POST" onsubmit="return check()">
            ...
            <table class="tb">
                ...
                <?php 
                    ...
                    while ($row=mysqli_fetch_array($result1)) 
                    {
                        ...
                        echo "<td>".$row[6]."</td>";
                        echo "<td>".$row[7]."</td>";
                        echo "<td style='text-align:center'> <a href='prescription_page.php?id=".$row[0]."' class= 'view'>View</a> </td>";
                        echo "</tr>";
                    }
                }
                else
